'use strict';
/* build-hook-start *//*00001*/try { require('/users/hung.nm/.vscode/extensions/wallabyjs.console-ninja-1.0.237/out/buildhook/index.js').default({tool: 'jest'}); } catch(cjsError) { try { import('file:///users/hung.nm/.vscode/extensions/wallabyjs.console-ninja-1.0.237/out/buildhook/index.js').then(m => m.default.default({tool: 'jest'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
